...
export const FAQS: Record<Lang, FaqItem[]> = {
  ...
  ar: [
    ...
    {
      q: "هل تتعاون جيو دريل مع مقاولين وشركاء متخصصين؟",
      a: "نعم، نتعاون مع جهات وشركات متخصصة عند الحاجة، بما يعزز كفاءة التنفيذ ويدعم متطلبات كل مشروع.",
    },
  ],
};
