...
import { TechnicalBadge } from '@/components/geotech/technical-badge';
import { ContourLines } from '@/components/geotech/geological/background';
import { siteImages } from '@/lib/geotech-images';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          >
              ...
              <div className="absolute inset-x-0 bottom-0 p-4">
                <div className="flex items-center gap-2 rounded-md border border-border/40 bg-background/60 p-3 backdrop-blur-md">
                  ...
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">Field Investigation</span>
                    <span className="text-sm font-medium">Subsurface Drilling</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <span className="font-mono text-[9px] text-muted-foreground/60 [writing-mode:vertical-rl]">0m</span>
              <div className="my-1 w-px flex-1 bg-gradient-to-b from-primary/40 to-transparent" />
              <span className="font-mono text-[9px] text-muted-foreground/60 [writing-mode:vertical-rl]">30m</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
