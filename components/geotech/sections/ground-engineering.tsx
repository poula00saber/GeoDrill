...
export function GroundEngineering() {
  ...
  const items = Object.entries(dict.groundEngineering.items).map(([key, label]) => ({
    key,
    label,
  }));
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              {items.map((item, i) => (
                ...
                >
                  <span className="font-mono text-[9px] text-muted-foreground/50">0{i + 1}</span>
          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden rounded-lg border border-border/40">
              <div
                ...
                style={{ backgroundImage: `url(${siteImages.groundEngineering})` }}
              />
              ...
              <div className="absolute inset-x-0 bottom-0 p-4">
                <div className="flex items-center gap-2 rounded-md border border-border/40 bg-background/60 p-3 backdrop-blur-md">
                  ...
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">Specialized Solutions</span>
                    <span className="text-sm font-medium">Site-Specific Engineering</span>
                  </div>
                </div>
              </div>
            </div>
