...
/**
 * Modern sub-page hero banner: full-bleed background image with a navy grade,
 * breadcrumb trail, a gold kicker accent, a large title and an optional intro.
 * Shown at the top of internal pages (sector pages, and future pages).
 */
export function PageHero({
  ...
  title: string
  sub?: string
  /** Extra breadcrumb segment shown after the home link. */
  crumb: string
}) {
  const { lang } = useLanguage()
  return (
    <section className="relative flex min-h-[46vh] items-end overflow-hidden bg-navy pt-28 pb-16 text-white md:pb-20">
