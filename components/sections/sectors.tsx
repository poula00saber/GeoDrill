            ...
            >
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-center justify-between p-5">
                  ...
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-teal/0 text-white transition-all group-hover:bg-teal ltr:group-hover:translate-x-0 rtl:group-hover:-translate-x-0">
                    <svg
