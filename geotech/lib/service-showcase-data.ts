  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/material-testing-quality-control1.jpg`,
      icon: Beaker,
      tone: "amber",
      labelAr: "التربة والركام",
      descriptionAr:
        "تصنيف التربة واختبار الدمك والركام — تحليل المناخل، حدود أتربرج، بروكتور/CBR، الكبريتات والكلوريد، الثباتية، وسحق لوس أنجلوس.",
      featuresAr: [
        "المناخل، الهيدرومتر، وحدود أتربرج",
        "بروكتور، CBR والكثافة النسبية",
        "الثباتية، سحق لوس أنجلوس، الكبريتات والكلوريد",
      ],
    },
    {
      id: "concrete",
      ...
      image: `/images/geotech/services/grok/material-testing-quality-control2.jpg`,
      icon: TestTube2,
      tone: "primary",
      labelAr: "اختبار الخرسانة",
      descriptionAr:
        "اختبار الخرسانة الطازجة والمتصلدة — الهبوط، الحرارة، محتوى الهواء، مقاومة الانضغاط، الاختبارات اللاإتلافية (شميت، الموجات فوق الصوتية، نصف الخلية) وأخذ اللب.",
      featuresAr: [
        "طازجة: هبوط، حرارة، هواء، أخذ عينات",
        "لا إنتلافية: شميت، الموجات فوق الصوتية، السحب، نصف الخلية",
        "إتلافية: مكعبات، لب، انحناء",
      ],
    },
    {
      id: "asphalt-cement",
      ...
      image: `/images/geotech/services/grok/material-testing-quality-control3.jpg`,
      icon: Layers3,
      tone: "sky",
      labelAr: "الأسفلت والأسمنت",
      descriptionAr:
        "تصميم خلطات الأسفلت، ثبات مارشال، اختبار البيتومين ومراقبة جودة الأسمنت (النعومة، زمن الشك، مقاومة الانضغاط، فقدان الوزن بالاحتراق).",
      featuresAr: [
        "مارشال، الاستخلاص وأخذ اللب",
        "اختراق البيتومين، المطاوعة، اللزوجة",
        "الأسمنت: الكثافة النوعية، الشك، المقاومة، النعومة",
      ],
    },
    {
      id: "qc-steel-pile",
      ...
      image: `/images/geotech/services/grok/material-testing-quality-control4.jpg`,
      icon: ShieldAlert,
      tone: "emerald",
      labelAr: "مراقبة الجودة، الفولاذ، والركائز",
      descriptionAr:
        "مراقبة الجودة في الموقع، الاختبارات الميكانيكية للحديد (الكلتة المرنة، المتانة، الاستطالة، الانحناء) واختبار سلامة الأساسات (PDA، PIT، CHL، MCL، السحب).",
      featuresAr: [
        "الكثافة الحقلية ومراقبة الخرسانة في الموقع",
        "حديد: مقاومة الخضوع/المتانة/الانحناء",
        "الأساسات: PDA، PIT، CHL، MCL، اختبار السحب",
      ],
    },
  ],
};
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/topographical-survey1.jpg`,
      icon: Map,
      tone: "amber",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/topographical-survey2.jpg`,
      icon: Compass,
      tone: "primary",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/topographical-survey3.jpg`,
      icon: Satellite,
      tone: "sky",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/topographical-survey4.jpg`,
      icon: Waves,
      tone: "violet",
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/hydrogeological-studies1.jpg`,
      icon: Droplets,
      tone: "sky",
      labelAr: "آبار المياه",
      descriptionAr:
        "حفر آبار مياه للاستخدام المنزلي والزراعي والصناعي مع تقييم شامل لأداء الخزان الجوفي.",
      featuresAr: [
        "آبار منزلية/زراعية/صناعية",
        "اختبارات الضخ والاختبار اللحظي",
        "تقييم أداء الخزان الجوفي",
      ],
    },
    {
      id: "permeability",
      ...
      image: `/images/geotech/services/grok/hydrogeological-studies2.jpg`,
      icon: FlaskConical,
      tone: "blue",
      labelAr: "النفاذية والتوصيل الهيدروليكي",
      descriptionAr:
        "اختبارات النفاذية والتوصيل الهيدروليكي بطرق حقلية ومعملية لتحديد سعة الآبار وإنتاجيتها.",
      featuresAr: [
        "اختبارات نفاذية حقلية",
        "اختبارات معملية ذات منسوب ثابت/متغير",
        "توصيف التوصيل الهيدروليكي",
      ],
    },
    {
      id: "quality",
      ...
      image: `/images/geotech/services/grok/hydrogeological-studies3.jpg`,
      icon: TestTube2,
      tone: "violet",
      labelAr: "جودة المياه",
      descriptionAr:
        "التحاليل الكيميائية والميكروبيولوجية لجودة المياه لمشاريع الشرب والزراعة والصناعة.",
      featuresAr: [
        "تحليل المعايير الكيميائية",
        "الاختبار الميكروبيولوجي",
        "تقارير الامتثال والصالحة للشرب",
      ],
    },
    {
      id: "geoelectric",
      ...
      image: `/images/geotech/services/grok/hydrogeological-studies4.jpg`,
      icon: Radio,
      tone: "emerald",
      labelAr: "المسح الكهربائي",
      descriptionAr:
        "مسوحات كهربائية لتوصيف باطن الأرض ورسم الخرائط الجوفية — بديل سريع وغير جراحي للحفر.",
      featuresAr: [
        "السبر الكهربائي العمودي",
        "التصوير بالمقاومة النوعية",
        "رسم خرائط الخزان الجوفي",
      ],
    },
  ],
};
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/cavity-probing1.jpg`,
      icon: Shovel,
      tone: "amber",
      labelAr: "كشف التجاويف",
      descriptionAr:
        "التحقق والكشف عن التجاويف تحت الأساسات والأرصفة باستخدام الجيوفيزياء وتقنيات الحفر لاستكشاف الفراغات الجوفية.",
      featuresAr: [
        "الجيوفيزياء: رادار اختراق الأرض",
        "حفر تحقق دقيق موجه",
        "رسم خرائط التجاويف",
      ],
    },
    {
      ...
      image: `/images/geotech/services/grok/cavity-probing2.jpg`,
      icon: Droplets,
      tone: "primary",
      labelAr: "الحقن بالضغط",
      descriptionAr:
        "الحقن بالضغط لتحسين التربة وعلاج الفراغات تحت الأساسات بإسمنت أو مواد كيميائية متخصصة.",
      featuresAr: [
        "حقن الإسمنت والميكروإسمنت",
        "الحقن الكيميائي المتخصص",
        "علاج الفراغات",
      ],
    },
    {
      ...
      image: `/images/geotech/services/grok/cavity-probing3.jpg`,
      icon: Hammer,
      tone: "sky",
      labelAr: "الركائز الدقيقة",
      descriptionAr:
        "تنفيذ الركائز الدقيقة لتحسين قدرة تحمل التربة ونقل الأحمال إلى طبقات أعمق وأكثر استقرارًا.",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/cavity-probing4.jpg`,
      icon: Wrench,
      tone: "violet",
      labelAr: "الحقن بالدمك",
      descriptionAr:
        "حقن الدمك لرفع وتحسين التربة تحت الأساسات، ومعالجة الهبوط وتقوية التربة السطحية.",
      featuresAr: [
        "رفع الهبوط",
        "تحسين قدرة تحمل التربة",
        "تقليل مخاطر الهبوط المستقبلي",
      ],
    },
  ],
};
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/structural-assessment1.jpg`,
      icon: Eye,
      tone: "amber",
      labelAr: "الفحوصات البصرية",
      descriptionAr:
        "فحوصات بصرية تفصيلية لتقييم حالة الهياكل القائمة وتحديد التشققات والأضرار الظاهرة.",
      featuresAr: [
        "فحص الشقوق والتشوهات",
        "تقييم حالة المواد",
        "توثيق تفصيلي بصري",
      ],
    },
    {
      ...
      image: `/images/geotech/services/grok/structural-assessment2.jpg`,
      icon: ScanLine,
      tone: "primary",
      labelAr: "الاختبارات اللاإتلافية",
      descriptionAr:
        "اختبارات لا إنتلافية (Schmidt، الموجات فوق الصوتية، نصف الخلية، مطرقة الارتداد) لتقييم قوة وصلابة الهياكل الخرسانية دون تلف.",
      featuresAr: [
        "مطرقة شميت الارتدادية",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/structural-assessment3.jpg`,
      icon: Building2,
      tone: "blue",
      labelAr: "التحليل الإنشائي",
      descriptionAr:
        "تحليل إنشائي شامل لتقييم قدرة المنشآت القائمة على تحمل الأحمال وتحديد الإجراءات التصحيحية اللازمة.",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/structural-assessment4.jpg`,
      icon: ShieldAlert,
      tone: "rose",
      labelAr: "الأضرار والحوادث والأساسات",
      descriptionAr:
        "تقارير الأضرار والحوادث وفحص الأساسات لتحديد أسباب التشققات والهبوط واقتراح حلول الترميم.",
      featuresAr: [
        "تقارير فحص الأضرار",
        "تحقيق أسباب الهبوط",
        "اقتراحات الترميم",
  ...
  capabilities: [
    {
      ...
      image: "/images/geotech/services/grok/environmental-survey1.jpg",
      icon: Leaf,
      tone: "emerald",
    ...
    },
    {
      ...
      features: [
        ...
        "Permit & compliance support",
            ...
            image: "/images/geotech/services/grok/environmental-survey2.jpg",
      icon: FlaskConical,
      tone: "amber",
    ...
    },
    {
      ...
      image: "/images/geotech/services/grok/environmental-survey3.jpg",
      icon: Wind,
      tone: "sky",
    ...
    },
    {
      ...
      image: "/images/geotech/services/grok/environmental-survey4.jpg",
      icon: Eye,
      tone: "violet",
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/anchoring-shoring-design-execution1.jpg`,
      icon: Anchor,
      tone: "amber",
      labelAr: "مراسي التربة والدعائم الخلفية",
      descriptionAr:
        "تصميم وتنفيذ مراسي التربة والدعائم الخلفية لتثبيت الجدران الاستنادية والمنحدرات والحفريات العميقة.",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/anchoring-shoring-design-execution2.jpg`,
      icon: Layers3,
      tone: "primary",
      labelAr: "الجدران الاستنادية",
      descriptionAr:
        "تصميم وتنفيذ الجدران الاستنادية الخرسانية والمسلحة لدعم الحفريات ومنع انزلاق التربة.",
      featuresAr: [
        "تصميم الجدران الاستنادية",
        "تنفيذ الجدران",
        "التصريف والتحميل",
      ],
    },
    {
      ...
      features: ["Shotcrete facing", "Soil nail systems", "Erosion control"],
      image: `/images/geotech/services/grok/anchoring-shoring-design-execution3.jpg`,
      icon: Wrench,
      tone: "sky",
      labelAr: "الخرسانة المرشوشة ومسامير التربة",
      descriptionAr:
        "تطبيق الخرسانة المرشوشة مع مسامير التربة لتثبيت المنحدرات والحفريات المؤقتة.",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/anchoring-shoring-design-execution4.jpg`,
      icon: MountainSnow,
      tone: "violet",
      labelAr: "تقوية المنحدرات",
      descriptionAr:
        "حلول متكاملة لتقوية المنحدرات المعرضة للانزلاق باستخدام تقنيات هندسية متنوعة.",
      featuresAr: [
        "تقييم مخاطر المنحدر",
        "تصميم أنظمة التقوية",
        "تنفيذ حلول التقوية",
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/dewatering-design-execution1.jpg`,
      icon: Droplets,
      tone: "sky",
      labelAr: "الآبار العميقة",
      descriptionAr:
        "تصميم وتنفيذ أنظمة الآبار العميقة لخفض منسوب المياه الجوفية في الحفريات والمشاريع الكبيرة.",
      featuresAr: [
        "تصميم شبكة الآبار",
        "حفر وتركيب الآبار العميقة",
        "مضخات خفض منسوب المياه",
      ],
    },
    {
      id: "wellpoints",
      ...
      image: `/images/geotech/services/grok/dewatering-design-execution2.jpg`,
      icon: FlaskConical,
      tone: "blue",
      labelAr: "أنظمة آبار النقاط",
      descriptionAr:
        "أنظمة آبار النقاط لخفض منسوب المياه في الحفريات الضحلة والمتوسطة بكفاءة ومرونة عالية.",
      featuresAr: [
        "تصميم نظام النقاط",
        "تركيب الرأس والمضخات",
        "مراقبة مستمرة",
      ],
    },
    {
      ...
      image: `/images/geotech/services/grok/dewatering-design-execution3.jpg`,
      icon: Waves,
      tone: "violet",
      labelAr: "أنظمة الرفع بالمحرّك",
      descriptionAr:
        "أنظمة الرفع بالمحرّك (Eductor) لخفض منسوب المياه في الحفريات العميقة والمعقدة.",
      featuresAr: [
        "رفع المياه بالضغط",
        "مناسبة للأعماق الكبيرة",
        "كفاءة في الترب الدقيقة",
      ],
    },
    {
      id: "sump-monitoring",
      ...
      image: `/images/geotech/services/grok/dewatering-design-execution4.jpg`,
      icon: Compass,
      tone: "emerald",
      labelAr: "الحُفر والمراقبة",
      descriptionAr:
        "حُفر تجميع المياه الجوفية مع أنظمة مراقبة لحظية لضمان جفاف الموقع وسلامة الحفريات.",
  ...
  capabilities: [
    {
      ...
      image: `/images/geotech/services/grok/soil-improvement-concrete-repair1.jpg`,
      icon: Layers3,
      tone: "primary",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/soil-improvement-concrete-repair2.jpg`,
      icon: Hammer,
      tone: "amber",
      labelAr: "الركائز الدقيقة",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/soil-improvement-concrete-repair3.jpg`,
      icon: Wrench,
      tone: "sky",
      labelAr: "حقن التربة",
    ...
    },
    {
      ...
      image: `/images/geotech/services/grok/soil-improvement-concrete-repair4.jpg`,
      icon: ShieldAlert,
      tone: "violet",
