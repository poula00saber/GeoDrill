...
const arabicServiceOverviews: Record<string, string[]> = {
  ...
  "hydrology-studies": [
    ...
    "نستخدم البرامج المتقدمة ونماذج نظم المعلومات الجغرافية والتحقيقات الميدانية لتقييم الجريان ومخاطر الفيضانات والتغذية الجوفية والتوازن المائي.",
  ],
  "hydrogeological-studies": [
  ...
  "geological-survey-rock-slope-stability": [
    "تقدم جيو دريل مسوحات جيولوجية شاملة وتقييمات لثبات المنحدرات الصخرية لمشاريع البنية التحتية والتعدين والمشاريع البيئية.",
  ...
  "structural-assessment": [
    ...
    "ينفذ فريقنا الفحوصات البصرية والاختبارات غير الإتلافية والتحليل الإنشائي المتقدم، ويقدم توصيات عملية للترميم والامتثال وتقليل المخاطر.",
  ],
  "environmental-survey": [
  ...
  "soil-improvement-concrete-repair": [
    "تقدم جيو دريل خدمات تحسين التربة وإعادة تأهيل وإصلاح العناصر الخرسانية لدعم متانة البنية التحتية وإطالة عمرها الافتراضي.",
    "تشمل الحلول تقوية المنشآت بالألياف، والخوازيق الدقيقة، وحقن التربة، وأعمال التغليف، وإصلاح الأرضيات بالإيبوكسي للحد من مخاطر الهبوط والتدهور.",
  ],
  "mining-exploration": [
