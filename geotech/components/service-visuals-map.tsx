...
function ShowcaseFor({ slug }: { slug: string }) {
  ...
  return <ServiceVisualShowcase slug={slug} capabilities={config.capabilities} />;
}
...
export const serviceVisuals: Partial<Record<string, ComponentType>> = {
  ...
  "hydrogeological-studies": () => <ShowcaseFor slug="hydrogeological-studies" />,
  "cavity-probing-grouting-micro-piling": () => <ShowcaseFor slug="cavity-probing-grouting-micro-piling" />,
  ...
  "anchoring-shoring-design-execution": () => <ShowcaseFor slug="anchoring-shoring-design-execution" />,
  "dewatering-design-execution": () => <ShowcaseFor slug="dewatering-design-execution" />,
  "soil-improvement-concrete-repair": () => <ShowcaseFor slug="soil-improvement-concrete-repair" />,
